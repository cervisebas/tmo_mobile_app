...
export const BackgroundTaskConfigItem = React.memo(function () {
  ...
  const { value: valueInterval, change: changeInterval } =
    useBackgroundTaskInterval();
  ...
  return (
    <React.Fragment>
      <ItemWithCheckbox
        ...
        description={
          'Recibí avisos cuando haya nuevos capítulos de los mangas que marcaste como favorito o que estés siguiendo.'
        }
